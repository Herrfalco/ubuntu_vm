...
if [ -n "${TINYMIST_INSTALLER_GHE_BASE_URL:-}" ]; then
    INSTALLER_BASE_URL="$TINYMIST_INSTALLER_GHE_BASE_URL"
else
    INSTALLER_BASE_URL="${TINYMIST_INSTALLER_GITHUB_BASE_URL:-https://github.com}"
fi
if [ -n "${INSTALLER_DOWNLOAD_URL:-}" ]; then
    ARTIFACT_DOWNLOAD_URL="$INSTALLER_DOWNLOAD_URL"
else
    ARTIFACT_DOWNLOAD_URL="${INSTALLER_BASE_URL}/Myriad-Dreamin/tinymist/releases/download/v0.13.26"
fi
PRINT_VERBOSE=${INSTALLER_PRINT_VERBOSE:-0}
PRINT_QUIET=${INSTALLER_PRINT_QUIET:-0}
if [ -n "${TINYMIST_NO_MODIFY_PATH:-}" ]; then
    NO_MODIFY_PATH="$TINYMIST_NO_MODIFY_PATH"
else
    NO_MODIFY_PATH=${INSTALLER_NO_MODIFY_PATH:-0}
fi
if [ "${TINYMIST_DISABLE_UPDATE:-0}" = "1" ]; then
    INSTALL_UPDATER=0
else
    INSTALL_UPDATER=1
fi
UNMANAGED_INSTALL="${TINYMIST_UNMANAGED_INSTALL:-}"
if [ -n "${UNMANAGED_INSTALL}" ]; then
    NO_MODIFY_PATH=1
    INSTALL_UPDATER=0
fi
AUTH_TOKEN="${TINYMIST_GITHUB_TOKEN:-}"

read -r RECEIPT <<EORECEIPT
{"binaries":["CARGO_DIST_BINS"],"binary_aliases":{},"cdylibs":["CARGO_DIST_DYLIBS"],"cstaticlibs":["CARGO_DIST_STATICLIBS"],"install_layout":"unspecified","install_prefix":"AXO_INSTALL_PREFIX","modify_path":true,"provider":{"source":"cargo-dist","version":"0.28.6-tinymist.3"},"source":{"app_name":"tinymist","name":"tinymist","owner":"Myriad-Dreamin","release_type":"github"},"version":"0.13.26"}
EORECEIPT
...
RECEIPT_HOME="${XDG_CONFIG_HOME:-$INFERRED_HOME/.config}/tinymist"
...
The installer for tinymist 0.13.26

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/Myriad-Dreamin/tinymist/releases/download/v0.13.26
...
download_binary_and_run_installer() {
    ...
    for arg in "$@"; do
        case "$arg" in
            ...
            --verbose)
                ...
                ;;
            --no-modify-path)
                say "--no-modify-path has been deprecated; please set TINYMIST_NO_MODIFY_PATH=1 in the environment"
                NO_MODIFY_PATH=1
                ;;
            *)
                OPTIND=1
    ...
    case "$_artifact_name" in 
        "tinymist-aarch64-apple-darwin.tar.gz")
            ...
            _checksum_value="f2cfea38e2f67d38f99b8f23a859ebbc4568f2c4fca2a38778fe9239523fdaa0"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
            _staticlibs=""
        ...
        "tinymist-aarch64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="d6ad52bc1a5ea86633b4e8ad07160434b7ee3cd3f3e1084f2fac0e6366085384"
            _bins="tinymist.exe"
            _bins_js_array='"tinymist.exe"'
            _libs=""
            _libs_js_array=""
            _staticlibs=""
            _staticlibs_js_array=""
        ...
        "tinymist-aarch64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="2a4f1c1827ce98919cb4868ef4e6be2f8e6affea3d5090093e53d87c21ecc6bf"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-aarch64-unknown-linux-musl.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="097349f54e606bac25c4e9adbba4490ec94378e91ac56cfb1924eb7d02ca6d58"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-arm-unknown-linux-gnueabihf.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="e3871af952a184be8f1dabde9b3604d78e83aa0cfce3f7e350320975505fc970"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-arm-unknown-linux-musleabihf.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="21ccff048cc37b91a5977122c104b433ded704dbc00bcc5de20c4c58a5117e4e"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-armv7-unknown-linux-gnueabihf.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="859b771dd0c3ec247ecf6c574b39e0434ab8a4bb0c1dcff72f8213cf390fbb54"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-armv7-unknown-linux-musleabihf.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="e73e466019357e3ffc1e5ee52559bb8de563fceebcd8820a68a708798d2dbb7a"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-loongarch64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="c01a3bc5ebc59c7a45e7cb47efcc52b0388739c700b0d355ca4b0e39e642ecd3"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-loongarch64-unknown-linux-musl.tar.gz")
            _arch="loongarch64-unknown-linux-musl-static"
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="ae02efde35fd378731e66103ee94df67296a756e750c579567934d6813cf61e9"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-riscv64gc-unknown-linux-musl.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="4f1108bdea7fb11b8e91b1cd70136f114ebe98aab2dc1f740c19b60d96a4f32a"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-x86_64-apple-darwin.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="268f3748580ff8c7c1c7b921dc2dab5e91f72ef2ddecf1a443212b1ae32c0a51"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-x86_64-pc-windows-msvc.zip")
            ...
            _zip_ext=".zip"
            _checksum_style="sha256"
            _checksum_value="27a5b13893727db4cf88387f48a9f3009d5a00a45d5f1a7f5c7c3592e773d127"
            _bins="tinymist.exe"
            _bins_js_array='"tinymist.exe"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-x86_64-unknown-linux-gnu.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="5413d17644c309cf0aecec95d76d7643a6b20121f64859b22b5da9cedcba7149"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
        ...
        "tinymist-x86_64-unknown-linux-musl.tar.gz")
            ...
            _zip_ext=".tar.gz"
            _checksum_style="sha256"
            _checksum_value="bfc2a70c85f3d82147a08cc2bdb3003f2c7da7e01683b04e281e48f226ed36d0"
            _bins="tinymist"
            _bins_js_array='"tinymist"'
            _libs=""
            _libs_js_array=""
...
json_binary_aliases() {
    ...
    "loongarch64-unknown-linux-gnu")
        echo '{}'
        ;;
    "loongarch64-unknown-linux-musl-dynamic")
        echo '{}'
        ;;
    "loongarch64-unknown-linux-musl-static")
        echo '{}'
        ;;
...
select_archive_for_arch() {
    ...
    case "$_true_arch" in 
        "aarch64-apple-darwin")
            _archive="tinymist-aarch64-apple-darwin.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
            _archive="tinymist-x86_64-apple-darwin.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
            ;;
        "aarch64-pc-windows-gnu")
            _archive="tinymist-aarch64-pc-windows-msvc.zip"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
        ...
        "aarch64-pc-windows-msvc")
            ...
            _archive="tinymist-x86_64-pc-windows-msvc.zip"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
            ;;
        "aarch64-unknown-linux-gnu")
            _archive="tinymist-aarch64-unknown-linux-gnu.tar.gz"
            ...
            _archive="tinymist-aarch64-unknown-linux-musl.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
        ...
        "aarch64-unknown-linux-musl-static")
            ...
            ;;
        "arm-unknown-linux-gnueabihf")
            _archive="tinymist-arm-unknown-linux-gnueabihf.tar.gz"
            if ! check_glibc "2" "35"; then
                _archive=""
            fi
            if [ -n "$_archive" ]; then
            ...
            _archive="tinymist-arm-unknown-linux-musleabihf.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
        ...
        "arm-unknown-linux-musl-staticeabihf")
            ...
            ;;
        "armv7-unknown-linux-gnueabihf")
            _archive="tinymist-armv7-unknown-linux-gnueabihf.tar.gz"
            if ! check_glibc "2" "35"; then
                _archive=""
            fi
            if [ -n "$_archive" ]; then
            ...
            _archive="tinymist-armv7-unknown-linux-musleabihf.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
        ...
        "armv7-unknown-linux-musl-staticeabihf")
            ...
            ;;
        "loongarch64-unknown-linux-gnu")
            _archive="tinymist-loongarch64-unknown-linux-gnu.tar.gz"
            if ! check_glibc "2" "35"; then
                _archive=""
            fi
            if [ -n "$_archive" ]; then
            ...
            _archive="tinymist-loongarch64-unknown-linux-musl.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
        ...
        "loongarch64-unknown-linux-musl-static")
            ...
            ;;
        "riscv64gc-unknown-linux-gnu")
            _archive="tinymist-riscv64gc-unknown-linux-musl.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
        ...
        "x86_64-pc-windows-msvc")
            ...
            ;;
        "x86_64-unknown-linux-gnu")
            _archive="tinymist-x86_64-unknown-linux-gnu.tar.gz"
            if ! check_glibc "2" "35"; then
                _archive=""
            fi
            if [ -n "$_archive" ]; then
            ...
            _archive="tinymist-x86_64-unknown-linux-musl.tar.gz"
            if [ -n "$_archive" ]; then
                echo "$_archive"
                return 0
            fi
...
install() {
    ...
    if [ -n "${TINYMIST_INSTALL_DIR:-}" ]; then
        _force_install_dir="$TINYMIST_INSTALL_DIR"
